...
$sql = "SELECT laporan.*, manajemen_proyek.nama_proyek 
        FROM laporan 
        INNER JOIN manajemen_proyek ON laporan.id_proyek = manajemen_proyek.id_proyek";
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tampilan ini menyajikan data laporan secara rinci dan terstruktur, memungkinkan anda dengan mudah menambah dan mengubah perkembangan setiap tahap proyek dan pelaporan tanggal dan progres proyek.</p>
                    <div class="col-md-12">
                        <a href="tambah.php" class="btn btn-primary mb-3 mr-2"><i class="fa fa-plus"></i> Tambah Laporan</a>
                    </div>
                    <!-- DataTales Example -->
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<td>
                                                        <a href="ubah.php?id_laporan=' . $row["id_laporan"] . '"><i class="fa fa-edit"></i></a>
                                                        <a href="#" onclick="confirmDeletion(' . $row["id_laporan"] . ')"><i class="fa fa-trash"></i></a>
                                                      </td>'; 
                                                echo "</tr>";
                                                $index++;
                                            }
    ...
    <script>
        ...
        function confirmDeletion(id_laporan) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'hapus.php?id_laporan=' + id_laporan;
                }
            });
        }
    </script>
