...
$sql = "SELECT * FROM manajemen_anggaran WHERE id_anggaran = $id_anggaran";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE manajemen_anggaran SET id_proyek='$id_proyek', anggaran='$anggaran' WHERE id_anggaran=$id_anggaran";
    if ($conn->query($sql) === TRUE) {
        echo json_encode(['status' => 'success', 'message' => 'Anggaran berhasil diubah!']);
        exit();
    } else {
...
<head>
    ...
    <title>Ubah Anggaran - SIDAPIT</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid form-container">
                    ...
                    <h2 class="form-title">Ubah Anggaran</h2>
                    <form id="ubahForm" action="ubahForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="anggaran" name="anggaran" value="<?php echo $row['anggaran']; ?>" required>
                        </div>
