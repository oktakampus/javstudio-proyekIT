...
$sql = "SELECT manajemen_tim.*, manajemen_proyek.nama_proyek 
        FROM manajemen_tim 
        INNER JOIN manajemen_proyek ON manajemen_tim.id_proyek = manajemen_proyek.id_proyek";
...
<head>
    ...
    <title>Manajemen Tim - SIDAPIT</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manajemen Tim</h1>
                    <p class="mb-4">Tampilan ini menyajikan data tim secara rinci dan terstruktur, memungkinkan anda dengan mudah menambah dan mengubah perkembangan setiap tahap proyek. manajemen tim juga memberikan visibilitas penuh terhadap status proyek, sehingga tim manajemen dapat memastikan proyek berjalan sesuai rencana.</p>
                    <div class="col-md-12">
                        <a href="tambah.php" class="btn btn-primary mb-3 mr-2"><i class="fa fa-plus"></i> Tambah Tim</a>
                    </div>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Manajemen Tim</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row["proyek_manager"] . "</td>";
                                                echo "<td>" . $row["anggota_team"] . "</td>";
                                                echo '<td>
                                                        <a href="ubah.php?id_tim=' . $row["id_tim"] . '"><i class="fa fa-edit"></i></a>
                                                        <a href="#" onclick="confirmDeletion(' . $row["id_tim"] . ')"><i class="fa fa-trash"></i></a>
                                                      </td>'; 
                                                echo "</tr>";
                                                $index++;
                                            }
    ...
    <script>
        ...
        function confirmDeletion(id_tim) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'hapus.php?id_tim=' + id_tim;
                }
            });
        }
    </script>
