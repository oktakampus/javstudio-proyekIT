...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO manajemen_tim (id_proyek, proyek_manager, anggota_team) VALUES ('$id_proyek', '$proyek_manager', '$anggota_team')";
   
    if ($conn->query($sql) === TRUE) {
        echo json_encode(['status' => 'success', 'message' => 'Tim berhasil ditambahkan!']);
        exit();
    } else {
...
<head>
    ...
    <title>Tambah Tim - SIDAPIT</title>
        ...
        <div class="container">
            ...
            <form id="tambahForm" method="post" class="mt-4" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="proyek_manager" name="proyek_manager" required>
                </div>
                <div class="form-group">
                    <label class="small mb-1" for="anggota_team">Anggota Tim ;</label>
                    <input name="anggota_team" id="anggota_team" class="form-control" required>
                </div>
